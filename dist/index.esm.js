...
var bunnyHeadMain = "data:image/svg+xml,%3Csvg width='24' height='32' viewBox='0 0 28 32' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='%231FC7D4' d='M1 19h17v11H1z'/%3E%3Cpath d='M1.034 24.506v-5.472H18V29.977H1.034z' fill='%2300f' fill-rule='evenodd'/%3E%3Cellipse cx='18.46' cy='23.862' rx='8.897' ry='10.023' fill='%2300f' fill-rule='evenodd'/%3E%3C/svg%3E";

var bunnyHeadMax = "data:image/svg+xml,%3Csvg width='24' height='32' viewBox='0 0 28 32' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='%231FC7D4' d='M1 19h17v11H1z'/%3E%3Cpath d='M1.034 24.506v-5.472H18V29.977H1.034z' fill='%2300f' fill-rule='evenodd'/%3E%3Cellipse cx='17.77' cy='22.874' rx='9.586' ry='10.46' fill='%2300f' fill-rule='evenodd'/%3E%3C/svg%3E";
...
var Icon$p = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/logo.png" })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#280D5F", textDisabled: "#BDC2C4", textSubtle: "#ffc156", disabled: "#E9EAEB", gradients: {
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/DrunkenDogeChat",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/doge_drunken",
    },
];
var MENU_HEIGHT = 64;
